    ...
    <div class=" bg-indigo-600 bg-opacity-50 p-4 ">
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class="w-full max-w-sm mx-auto bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://pps.whatsapp.net/v/t61.24694-24/328768676_524271279636024_8574569258804315784_n.jpg?ccb=11-4&oh=01_AdSZ_IkeScsN8L0qNLSYmTe92w8oQWsh2nSy3Fzb9rkRBw&oe=649EE2A6" alt="Bonnie image"/>
        ...
        <div class="grid grid-cols-2 gap-4 mt-4">
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class=" bg-amber-500 w-full max-w-sm mx-auto rounded overflow-hidden shadow-lg">
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class="w-full max-w-sm mx-auto p-4  bg-red-900 border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">CRUD</h5>

                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Un CRUD es
                        C -> Create
                        R -> Read
                        U -> Update
                        D -> Delete</p>
                        ...
                        <ul class="my-4 space-y-3">
                            ...
                            <!-- servicio 1 -->
                            <li>
                                <a href="{{ route('tasks.index') }}" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <!-- servicio 2 -->
                            <li>
                                <a href="{{ route('tasks.create') }}" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <li>
                                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap">Servicio 3</span>
                                </a>
                            </li>
                            <!-- servicio 3 -->
